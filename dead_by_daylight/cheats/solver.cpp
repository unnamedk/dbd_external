...
vector3 math::LinearPredictor::predict_position( float time ) const
{
...
static bool solve2d( const vector3 &origin, const math::ProjectileWeapon &weapon, const vector3 &target, math::Solution &sol )
{
...
bool math::solve( const vector3 &origin, const ProjectileWeapon &weapon, const LinearPredictor &target, Solution &sol )
{
