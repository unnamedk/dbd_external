...
namespace sdk
{
    ...
    {
        // BaseDBDPlayer
        char ipad[ 0x10 + 0x20 + 0x8 + 0x8 + 0x8 ];
        int character_index;
        pad( 0x24 );
    ...
    struct uterror_radius_receiver
    {
        pad( 0x130 );
        bool in_terror_radius;
    };
    ...
    struct acamper_player : adbdplayer
    {
        ...
        pad( 0x78 );
        uterror_radius_receiver *terror_radius_receiver;
        pad( 0x60 );
    ...
    struct abreakable_wall : ainteractable
    {
        enum class breakable_state_t : std::uint8_t
        {
            unbroken,
            broken
        };
    ...
    struct udbd_game_state : ugamestate
    {
        ...
        tarray<asearchable *> searchables;
        tarray<agenerator *> generators;
        tarray<aescapedoor *> escape_doors;
        tarray<ahatch *> hatches;
        tarray<reverse_bear_trap_remover_t *> rbt_removers;
        tarray<abasetrap *> base_traps;
